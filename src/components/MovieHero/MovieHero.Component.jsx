...
const MovieHero = () => {
    ...
    return <>
      <div>
         {/* mobile Screen and tab sized devices   */}
         <div className = "lg:hidden w-full">
            <img src = {`https://image.tmdb.org/t/p/original${movie.poster_path}`} alt = "coverposter" className = "m-4 rounded" style = {{width: "calc(100% - 2rem)"}} />
         </div>
      <div className = "flex flex-col gap-3 lg:hidden">
       ...
       <div className = "relative hidden w-full lg:block" style = {{height: "30rem"}}>
         ...
         <img src = {`https://image.tmdb.org/t/p/original${movie.backdrop_path}`} alt = "Backdrop poster" className = "w-full h-full" />
       </div>
     </div>  
    </>;
